...
10.times do
  ...
  User.create(first_name: first  ,last_name: last ,email:"#{first}.#{last}@gmail.com" ,age: rand(15..25) ,city_id: City.all.sample.id, description: Faker::Lebowski.quote, password: Faker::Internet.password) 
end
